...
def test_format_update_notification_contains_period_counts_and_clickable_link() -> None:
    report = {
        ...
        "steps": [
            ...
            {"command": ["scripts/fintablo_sync_daily.py"], "returncode": 0, "stdout": '{"transactions": 10, "final_rows": 8, "noncash_updates": 3, "noncash_updated": 2, "cash_missing": 4, "cash_created": 4, "errors": 0}'},
        ],
